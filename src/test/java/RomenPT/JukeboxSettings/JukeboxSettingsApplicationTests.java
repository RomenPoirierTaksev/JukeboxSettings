...
public class JukeboxSettingsApplicationTests{
	...
	@Test
	public void offsetNotAnInt() throws Exception{
		String id = "e9869bbe-887f-4d0a-bb9d-b81eb55fbf0a";
		String offset = "a";
		this.mvc.perform(get("/jukebox?id="+id+"&offset="+offset)).andExpect(status().isNotAcceptable());
	}
	@Test
	public void limitNotAnInt() throws Exception{
		String id = "e9869bbe-887f-4d0a-bb9d-b81eb55fbf0a";
		String limit = "h";
		this.mvc.perform(get("/jukebox?id="+id+"&limit="+limit)).andExpect(status().isNotAcceptable());
	}
	@Test
	public void offsetLessThanZero() throws Exception{
		String id = "e9869bbe-887f-4d0a-bb9d-b81eb55fbf0a";
		String offset = "-1";
		this.mvc.perform(get("/jukebox?id="+id+"&offset="+offset)).andExpect(status().isNotAcceptable());
	}
	@Test
	public void limitLessThanZero() throws Exception{
		String id = "e9869bbe-887f-4d0a-bb9d-b81eb55fbf0a";
		String limit = "-1";
		this.mvc.perform(get("/jukebox?id="+id+"&limit="+limit)).andExpect(status().isNotAcceptable());
	}
	...
	@Test
	public void listIsCorrectWithOffset() throws Exception{
		String id = "86506865-f971-496e-9b90-75994f251459";
		String offset = "10";
		this.mvc.perform(get("/jukebox?id="+id+"&offset="+offset)).andExpect(content().string(containsString("[5ca94a8a72473ac501b99033, 5ca94a8a75c231bb18715112, 5ca94a8a77e20d15a7d16d0a, 5ca94a8a8b58770bb38055a0, 5ca94a8aa2330a0762019ac0, 5ca94a8aafb9d8c4e4fddf02, 5ca94a8ab2c1285e53a89991, 5ca94a8ab592da6c6f2d562e, 5ca94a8ac3f21c47a72473ec, 5ca94a8ac470d3e47cd4713c, 5ca94a8ac5f85b8a59f9e3c8, 5ca94a8acc046e7aa8040605, 5ca94a8acfdeb5e01e5bdbe8, 5ca94a8ad2d584257d25ae50, 5ca94a8ad82e60f2448d2fc9, 5ca94a8adb81479f94dda744, 5ca94a8ae2b3a4fb2f0cfd78, 5ca94a8af0853f96c44fa858, 5ca94a8af9985926172d6e8d, 5ca94a8afa2bc9887b28ce87]")));
	}

	@Test
	public void listIsCorrectWithOffsetAndLimit() throws Exception{
		String id = "86506865-f971-496e-9b90-75994f251459";
		String offset = "5";
		String limit = "10";
		this.mvc.perform(get("/jukebox?id="+id+"&offset="+offset+"&limit="+limit)).andExpect(content().string(containsString("[5ca94a8a20905ffff6f0561c, 5ca94a8a2c516506b1f49500, 5ca94a8a3227b0a360f41078, 5ca94a8a4aeb7ab33a5e1047, 5ca94a8a59b8061f89644f43]")));
	}

	@Test
	public void listIsCorrectWithLimit() throws Exception{
		String id = "86506865-f971-496e-9b90-75994f251459";
		String limit = "25";
		this.mvc.perform(get("/jukebox?id="+id+"&limit="+limit)).andExpect(content().string(containsString("[5ca94a8a0735998f945f7276, 5ca94a8a13385f0c82aa9f2e, 5ca94a8a1639eb9ea30609f0, 5ca94a8a18f5576210fd012e, 5ca94a8a1d1bc6d59afb9392, 5ca94a8a20905ffff6f0561c, 5ca94a8a2c516506b1f49500, 5ca94a8a3227b0a360f41078, 5ca94a8a4aeb7ab33a5e1047, 5ca94a8a59b8061f89644f43, 5ca94a8a72473ac501b99033, 5ca94a8a75c231bb18715112, 5ca94a8a77e20d15a7d16d0a, 5ca94a8a8b58770bb38055a0, 5ca94a8aa2330a0762019ac0, 5ca94a8aafb9d8c4e4fddf02, 5ca94a8ab2c1285e53a89991, 5ca94a8ab592da6c6f2d562e, 5ca94a8ac3f21c47a72473ec, 5ca94a8ac470d3e47cd4713c, 5ca94a8ac5f85b8a59f9e3c8, 5ca94a8acc046e7aa8040605, 5ca94a8acfdeb5e01e5bdbe8, 5ca94a8ad2d584257d25ae50, 5ca94a8ad82e60f2448d2fc9]")));
	}

	@Test
	public void listIsCorrectWithOffsetAndLimitAndModel() throws Exception{
		String id = "86506865-f971-496e-9b90-75994f251459";
		String offset = "5";
		String limit = "10";
		String model = "angelina";
		this.mvc.perform(get("/jukebox?id="+id+"&offset="+offset+"&limit="+limit+"&model="+model)).andExpect(content().string(containsString("[5ca94a8aafb9d8c4e4fddf02, 5ca94a8acc046e7aa8040605, 5ca94a8ad82e60f2448d2fc9, 5ca94a8af9985926172d6e8d, 5ca94a8afa2bc9887b28ce87]")));
	}
}
